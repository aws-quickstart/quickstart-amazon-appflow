...
* *Deploy additional AppFlows for new Salesforce objects after deploying Amazon Appflow in a new VPC*. This option provisions {partner-product-short-name} in your existing AWS infrastructure.
