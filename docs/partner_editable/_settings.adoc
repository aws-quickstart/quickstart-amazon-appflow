...
:quickstart-project-name: quickstart-amazon-appflow
:partner-product-name: Amazon AppFlow
// For the following attribute, if you have no short name, enter the same name as partner-product-name.
:partner-product-short-name: Amazon AppFlow
...
:partner-contributors: Anirudh Rautela, Avdesh Mankotia, and Karandeep Singh, Trantor Inc.
