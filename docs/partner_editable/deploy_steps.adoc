...
. Navigate to the {marketplace_listing_url}[{partner-product-short-name} AMI in AWS Marketplace^], and then choose *Continue to Subscribe*.
. Review the terms and conditions for software usage, and then choose *Accept Terms*. +
  A confirmation page loads, and an email confirmation is sent to the account owner. For more information, see the https://aws.amazon.com/marketplace/help/200799470[Getting started^].
...
[cols="3,1"]
|===
^|https://fwd.aws/PpzVP?[Deploy {partner-product-short-name} into a new VPC on AWS^]
^|https://fwd.aws/vQw37?[View template^]

^|https://fwd.aws/ARV3P?[Deploy additional AppFlows for new Salesforce objects after deploying Amazon Appflow in a new VPC^]
^|https://fwd.aws/q4nMn?[View template^]
|===
+
